...
2. Create a new gateway and device.
3. Copy the **Gateway ID**, **Gateway Access Token**, and **Device ID** generated by the platform.
...
Ensure your `vonesetting.h` contains your WiFi SSID and Password, and the configured gateway ID and Access Token.
